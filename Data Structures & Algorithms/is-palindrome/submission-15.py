class Solution:
    def isPalindrome(self, s: str) -> bool:
        ...
        if sum([char.isalpha() or char.isnumeric() for char in s]) == 0:
            return True
        ...
        while pointer1 < pointer2:
            ...
            while not ((s[pointer1].isalpha()) | (s[pointer1].isnumeric())):
                pointer1 += 1
            while not ((s[pointer2].isalpha()) | (s[pointer2].isnumeric())):
                pointer2 -= 1
